...
1. [ ] Stabilize chapter AI pipeline — Tighten per-chapter AI job flow (error handling, retries, caching), ensure explain/summarize/mind map/Q&A payloads are generated deterministically and stored per chapter. `[S]`
